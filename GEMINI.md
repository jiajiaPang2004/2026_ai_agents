...
from ai2026.agent import root_agent
from google.genai import types as genai_types
...
async def main():
    ...
    await session_service.create_session(
        app_name="ai2026", user_id="test_user", session_id="test_session"
    )
    runner = Runner(
        agent=root_agent, app_name="ai2026", session_service=session_service
    )
